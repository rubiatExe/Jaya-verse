    ...
    return (
        <div className="space-y-8">
            <Card>
                ...
                <CardContent>
                    <div className="relative w-full max-w-4xl mx-auto aspect-video rounded-lg overflow-hidden border-2 border-primary/20">
                        <Image src="https://placehold.co/1000x500.png" alt="World Map" layout="fill" objectFit="cover" data-ai-hint="world map" />
                        {friendPins.map((pin) => (
